...
const checkboxBackground  = document.getElementById('checkboxBackground');
const checkboxRenderstyle = document.getElementById('checkboxRenderstyle');
const checkboxProjection  = document.getElementById('checkboxProjection');
...
const switchBackground = (() => {
   if (checkboxBackground.checked) {mybackground = "black"}
...
const switchRenderer = (() => {
   if (checkboxRenderstyle.checked) {renderstyle = patch}
   else {renderstyle = wire}
   render();
});
checkboxRenderstyle.checked = true;

const switchProjection = (() => {
   if (checkboxProjection.checked) {projType = persp}
   else {projType = ortho}
   render();
});
checkboxProjection.checked = true;
...

{
    ...
    checkboxBackground.addEventListener ('change', switchBackground , false);
    checkboxRenderstyle.addEventListener ('change', switchRenderer , false);
    checkboxProjection.addEventListener ('change', switchProjection , false);
